...
import static cc.easyandroid.filechooser.ChooserDialog.CHOOSE_MODE_DELETE;
import static cc.easyandroid.filechooser.ChooserDialog.CHOOSE_MODE_NORMAL;
import static cc.easyandroid.filechooser.ChooserDialog.CHOOSE_MODE_SELECT_MULTIPLE;
import static cc.easyandroid.filechooser.internals.UiUtil.getListYScroll;
...
import cc.easyandroid.filechooser.internals.UiUtil;
                ...
                public void onClick(final View view) {
                    ...
                    if (_c.get()._options == null) {
                        ...
                        final int rootId = _c.get()._context.getResources().getIdentifier("contentPanel", "id",
                            "android");
                        final ViewGroup root1 = ((AlertDialog) dialog).findViewById(rootId);
                        final ViewGroup root = ((AlertDialog) dialog).findViewById(R.id.contentPanel);
